...
export function HeroSection(props: HeroSectionProps) {
  return (
    <section id="HeroSection" className={styles['container']}>
      <div className={styles['container__top']}>
        <svg
          id="BackImg"
          className={styles['container__top__backMobile']}
          width="375"
          height="423"
        >
          <defs>
        ...
        <img
          className={styles['container__top__backDesktop']}
          src={SvgDesktop}
          alt=""
        />
        ...
        <img
          id="FrontImg"
          className={styles['container__top__front']}
          src={phoneImg}
          alt="Hero Img"
        />
      </div>
      <div id="ContainerBottom" className={styles['container__bottom']}>
        <h1 id="stagger" className={styles['container__bottom__title']}>
          Next generation digital banking
        </h1>
        <p id="stagger" className={styles['container__bottom__content']}>
          Take your financial life online. Your Easybank account will be a
          one-stop-shop for spending, saving, budgeting, investing, and much
          more.
        </p>
        <button id="stagger" className={styles['container__bottom__btn']}>
          {' '}
          Request Invite
        </button>
      </div>
